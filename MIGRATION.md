...
- **[-7. claude-starter v3.14 → v3.14.3](#-7-claude-starter-v314--v3143)** — the
...
## -7. claude-starter v3.14 → v3.14.3

Three patch releases on one finding. v3.14.1 exempted the session
